...
SWEP.ViewModel = "models/weapons/arccw_mwr_hrm9.mdl" -- I mean, you probably have to edit these too
SWEP.WorldModel = "models/weapons/w_rif_m4a1.mdl"

SWEP.MirrorVMWM = true -- Copy the viewmodel, along with all its attachments, to the worldmodel. Super convenient!
SWEP.MirrorWorldModel = "models/weapons/arccw_mwr_hrm9_wm.mdl" -- Use this to set the mirrored viewmodel to a different model, without any floating speedloaders or cartridges you may have. Needs MirrorVMWM
...
SWEP.ShootSound = "weapons/hrm9/fire_fp.wav"
SWEP.ShootSoundSilenced = "weapons/hrm9/fire_sup.wav"
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
       ...
       LHIKEaseIn = 0.1, -- how long LHIK eases in.
           ...
           SoundTable = {	
            {s = "weapons/hrm9/magout_empty.wav" , t = 0.32},
            {s = "weapons/hrm9/maghit_empty.wav" , t = 1.65},
            {s = "weapons/hrm9/magin_empty.wav", t = 1.85},
            {s = "weapons/hrm9/boltback.wav", t = 2.69},
            {s = "weapons/hrm9/boltfwd.wav", t = 2.85},
           },
    },
    ["reload"] = {
       Source = "reload",
       ...
       LHIKEaseIn = 0.1, -- how long LHIK eases in.
       SoundTable = {	
        {s = "weapons/hrm9/magout.wav" , t = 0.72},
        {s = "weapons/hrm9/maghit.wav" , t = 1.42},
        {s = "weapons/hrm9/magin.wav" , t = 1.55},
       },
   },
   }
...
SWEP.Hook_ModifyBodygroups = function(wep, data)
   ...
   SWEP.Attachments = {
    ...
    },
    {
        ...
        Bone = "weapon", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-1.2, -3.1, 7), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0,0),
        },
    },
    {
        ...
        Bone = "weapon", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-1.85, -4.8, -11), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
        },
    },
    {
        ...
        Offset = {
            vpos = Vector(0, -3.05, 10.5), -- offset that the attachment will be relative to the bone
            vang = Angle(-90, 0 ,-90),
        },
    },
}