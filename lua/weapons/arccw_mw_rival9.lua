...
SWEP.PrintName = "Rival-9"
SWEP.Trivia_Class = "PDW" -- "Submachine Gun"
SWEP.Trivia_Desc = "A compact , modular PDW." -- "Ubiquitous 9mm SMG. Created as a response to the need for a faster-firing and more reliable submachine gun than existing options at the time."
SWEP.Trivia_Manufacturer = "Matuzek" -- "Auschen Waffenfabrik"
...
SWEP.ViewModel = "models/weapons/arccw_mwr_rival9.mdl" -- I mean, you probably have to edit these too
SWEP.WorldModel = "models/weapons/w_rif_m4a1.mdl"

SWEP.MirrorVMWM = true -- Copy the viewmodel, along with all its attachments, to the worldmodel. Super convenient!
SWEP.MirrorWorldModel = "models/weapons/arccw_mwr_rival9_wm.mdl" -- Use this to set the mirrored viewmodel to a different model, without any floating speedloaders or cartridges you may have. Needs MirrorVMWM
...
SWEP.ShootSound = "weapons/rival9/fire_fp.wav"
SWEP.ShootSoundSilenced = "weapons/rival9/fire_sup.wav"
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
       ...
       LHIKEaseIn = 0.1, -- how long LHIK eases in.
           ...
           SoundTable = {	
            {s = "weapons/rival9/boltback.wav" , t = 0.23},
            {s = "weapons/rival9/magout_empty.wav" , t = 0.88},
            {s = "weapons/rival9/maghit_empty.wav" , t = 1.85},
            {s = "weapons/rival9/magin_empty.wav" , t = 2},
            {s = "weapons/rival9/boltslap.wav" , t = 2.5},
           },
    },
    ["reload"] = {
       Source = "reload",
       ...
       LHIKEaseIn = 0.1, -- how long LHIK eases in.
       SoundTable = {	
        {s = "weapons/rival9/maggrab.wav" , t = 0.5},
        {s = "weapons/rival9/magout.wav" , t = 0.55},
        {s = "weapons/rival9/maghit.wav" , t = 1.05},
        {s = "weapons/rival9/magin.wav" , t = 1.12},
       },
   },
   }
...
SWEP.Hook_ModifyBodygroups = function(wep, data)
    ...
    if hasOptic then
        vm:SetBodygroup(6, 1)  -- Custom bodygroup change for optics
        vm:SetBodygroup(5, 1)
    end
end
   ...
   SWEP.Attachments = {
    {
        ...
        Offset = {
            vpos = Vector(0, -4.4, 0.5), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
        },
    },
    {
        PrintName = "Handguard", -- print name
        DefaultAttName = "RIVAL-9 Factory.",
        Slot = {"hg_rival9"}, -- what kind of attachments can fit here, can be string or table
        Bone = "weapon", -- relevant bone any attachments will be mostly referring to
        InstalledEles = {"hg_custom"},
        Offset = {
            vpos = Vector(3.2, -5.9, -12.65), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
        },
    },
    {
        ...
        Bone = "weapon", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-1, -2.5, 7), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0,0),
        },
    },
    {
        ...
        Bone = "weapon", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(-1.85, -4.4, -10.5), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
        },
    },
    {
        ...
        Offset = {
            vpos = Vector(0, -2.52, 10.5), -- offset that the attachment will be relative to the bone
            vang = Angle(-90, 0 ,-90),
        },
    },
}