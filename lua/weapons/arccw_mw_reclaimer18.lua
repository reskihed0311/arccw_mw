...
SWEP.MirrorWorldModel = "models/weapons/arccw_mwr_reclaimer18_wm.mdl" -- Use this to set the mirrored viewmodel to a different model, without any floating speedloaders or cartridges you may have. Needs MirrorVMWM
...
SWEP.RecoilVMShake = 1.2-- random viewmodel offset when shooty
SWEP.ShotgunSpreadDispersion = 2 -- dispersion will cause pattern to increase instead of shifting
...
SWEP.SightsDispersion = 30-- dispersion that remains even in sights
